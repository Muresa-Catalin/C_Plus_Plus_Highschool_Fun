...
//namespace programing {
	...
	bool Screen::init() {
	    ...
	    m_window = SDL_CreateWindow("Particle fire Explision", SDL_WINDOWPOS_UNDEFINED, SDL_WINDOWPOS_UNDEFINED, SCREEN_WIDTH, SCREEN_HEIGHT, SDL_WINDOW_SHOWN);
		if (m_window == NULL) {
			SDL_Quit();
			return false;
		}
